...
class ChatScreen extends GetView<UserInfoController> {
  final String? userToken;
  final String? userEmail;
  final String? peerId;
  ChatScreen({Key? key, required this.userToken, required this.userEmail, required this.peerId})
      : super(key: key);
                ...
                IconButton(
                    onPressed: () {
                      if (msg.text.isNotEmpty) {
                        APIService().sendNotification(msg.text, userToken!);
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return ListTile(
                          title: Column(
                            crossAxisAlignment:
                                controller.loginUser?.email == x['user']
                            ...
                            children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: controller.loginUser?.email ==
                                              x['user']
